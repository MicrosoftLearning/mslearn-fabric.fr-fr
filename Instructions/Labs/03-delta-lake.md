...
1. Sur la page d’accueil de Microsoft Fabric à l’adresse https://app.fabric.microsoft.com, sélectionnez l’expérience **Engineering données Synapse**.
...
Le chemin complet doit être similaire a ceci :
...
Lorsque les données sont retournées, sélectionnez la vue **Graphique** pour afficher un graphique à barres.
