...
3. Créez un nouvel espace de travail avec le nom de votre choix, en sélectionnant un mode de licence qui inclut la capacité Fabric (*Essai*, *Premium* ou *Fabric*).
...
3. Sous l’onglet **Vue du lac** dans le volet de gauche, dans le menu **...** du nœud **Fichiers**, sélectionnez **Nouveau sous-dossier** et créez un sous-dossier nommé **new_data**.
